...
const (
	...
	CoffeeShop_PlaceOder_FullMethodName      = "/coffeeshop.CoffeeShop/PlaceOder"
...
type CoffeeShopClient interface {
	...
	PlaceOder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Receipt, error)
...
func (c *coffeeShopClient) PlaceOder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Receipt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Receipt)
	err := c.cc.Invoke(ctx, CoffeeShop_PlaceOder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoffeeShopServer interface {
	...
	PlaceOder(context.Context, *Order) (*Receipt, error)
...
func (UnimplementedCoffeeShopServer) PlaceOder(context.Context, *Order) (*Receipt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlaceOder not implemented")
}
...
func _CoffeeShop_PlaceOder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Order)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoffeeShopServer).PlaceOder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoffeeShop_PlaceOder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).PlaceOder(ctx, req.(*Order))
	}
...
var CoffeeShop_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PlaceOder",
			Handler:    _CoffeeShop_PlaceOder_Handler,
		},
		{
